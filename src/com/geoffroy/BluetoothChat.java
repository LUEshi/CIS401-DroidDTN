...
public class BluetoothChat extends Activity {  
	/* Last build (string */
	private final String lastBuild = "Nov 17 1:45pm";
	/* Using LogCat or not (only works on the emulator) */
	private boolean logging = false;
	private static final String TAG = "BluetoothChat";
	private static final boolean Debugging = true;
	
	/* TextView used to display logging on the device */
	TextView output;
	...
	/* Request code to enable Bluetooth (can be any int) */
    ...
    private void ensureDiscoverable() {
        if(Debugging) Log.d(TAG, "ensure discoverable");
    ...
    private TextView.OnEditorActionListener mWriteListener =
        ...
        public boolean onEditorAction(TextView view, int actionId, KeyEvent event) {
            ...
            if(Debugging) Log.i(TAG, "END onEditorAction");
            return true;
        }
    };
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_READ:
                ...
                /* GEOFF UPDATES */
                if(readMessage.startsWith(COMPARISON_VECTOR_MSG)) {
                	diffBlogComparisonVector(readMessage.substring(COMPARISON_VECTOR_MSG.length()));
                } else {
                	//mConversationArrayAdapter.add(mConnectedDeviceName+":  " + readMessage);
                	posts.add(new DataPacket(readMessage));
                }
                break;
     ...
     */
    public void sendBlogComparisonVector() {
    	ArrayList<Integer> localVector = DataPacket.getBlogComparisonVector(db);
    	sendMessage(COMPARISON_VECTOR_MSG + " " + TextUtils.join(";", localVector));
    }
     ...
     */
    public void diffBlogComparisonVector(String vectorString) {
    	ArrayList<Integer> vector = new ArrayList<Integer>();
    	String[] vectorArray = vectorString.split(";");
    	DataPacket post;
    	
    	for(String arrayEl : vectorArray) {
    		vector.add(Integer.valueOf(arrayEl));
    	}
    	
    	for(int hashCode : vector) {
    		if((post = getDataPacketFromHash(hashCode)) != null) {
    			sendMessage(post.toJson());
    		}
    	}
    }
